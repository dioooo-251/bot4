...
└ • *Link:* https://wa.me/${who.split`@`[0]}
 ...
 – *Status:*   ${who.split`@`[0] == global.nomorwa ? '🎗️ᴅᴇᴠᴇʟᴏᴘᴇʀ🎗️' : user.premiumTime >= 1 ? '👑ℙ𝕣𝕖𝕞𝕚𝕦𝕞👑' : user.level >= 1000 ? 'ᴇʟɪᴛᴇ ᴜsᴇʀ' : 'ғʀᴇᴇ ᴜsᴇʀ'}
...
┌ • *Premium:* ${user.premiumTime > 0 ? "☑️": "❌"} ${user.premiumTime > 0 ? `
│ • *Premiumtime:*
${clockString(user.premiumTime - new Date() * 1)}`: ''}
└ • *Registered:* ${user.registered ? '☑️ ( ' + new Date(regTime) + ' )' : '❌'}
